...
import ru.game.view.listeners.GameTypeListener;
...
public class SettingsWindow extends JDialog {
    ...
    public SettingsWindow(JFrame owner) {
        ...
        contentPane.add(createRadioButton(
                        "Novice (" + GameType.NOVICE.getMinesCount() + " mines, " + GameType.NOVICE.getColsCount() + "x" + GameType.NOVICE.getRowsCount() + ")",
                        GameType.NOVICE,
                        layout,
                        gridY++
                ));
        contentPane.add(createRadioButton(
                        "Medium (" + GameType.MEDIUM.getMinesCount() + " mines, " + GameType.MEDIUM.getColsCount() + "x" + GameType.MEDIUM.getRowsCount() + ")",
                GameType.MEDIUM,
                layout,
                gridY++
        ));
        contentPane.add(createRadioButton(
                        "Expert (" + GameType.EXPERT.getMinesCount() + " mines, " + GameType.EXPERT.getColsCount() + "x" + GameType.EXPERT.getRowsCount() + ")",
                GameType.EXPERT,
                layout,
                gridY++
        ));
